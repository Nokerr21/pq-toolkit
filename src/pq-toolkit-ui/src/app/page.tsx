      ...
      <Header>
        <div className="flex flex-col h-full w-full items-center justify-center my-auto fadeInUp mt-40">
          <div className="relative text-center mb-md">
            ...
            <div className='absolute top-10 right-64 w-80 h-80 bg-gradient-to-r from-pink-500 to-pink-700 rounded-full mix-blend-multiply filter blur-xl opacity-50 anima te-blob animation-delay-4000' />
